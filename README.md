...
![image](https://github.com/KiLlYoUrSeLf06/crhbys/blob/main/Screenshot/CLI(1).png)  
...
![image](https://github.com/KiLlYoUrSeLf06/crhbys/blob/main/Screenshot/CLI(2).png)  
 
```
ip -c a
```
 
![image](https://github.com/KiLlYoUrSeLf06/crhbys/blob/main/Screenshot/CLI(3).png)  
...
![image](https://github.com/KiLlYoUrSeLf06/crhbys/blob/main/Screenshot/ISP(2).png)  
![image](https://github.com/KiLlYoUrSeLf06/crhbys/blob/main/Screenshot/ISP(3).png)  
...
![image](https://github.com/KiLlYoUrSeLf06/crhbys/blob/main/Screenshot/ISP(4).png)  
...
![image](https://github.com/KiLlYoUrSeLf06/crhbys/blob/main/Screenshot/ISP(5).png)   
...
nmtui
```
![image](https://github.com/KiLlYoUrSeLf06/crhbys/blob/main/Screenshot/HQ-R(1).png)
![image](https://github.com/KiLlYoUrSeLf06/crhbys/blob/main/Screenshot/HQ-R(2).png)
...
enter
```
![image](https://github.com/KiLlYoUrSeLf06/crhbys/blob/main/Screenshot/HQ-R(3).png)  
```
systemctl restart network
ip -c a
```
![image](https://github.com/KiLlYoUrSeLf06/crhbys/blob/main/Screenshot/HQ-R(4).png)
...
nmtui
```
![image](https://github.com/KiLlYoUrSeLf06/crhbys/blob/main/Screenshot/BR-R(1).png)  
![image](https://github.com/KiLlYoUrSeLf06/crhbys/blob/main/Screenshot/BR-R(2).png)  
...
enter
```
![image](https://github.com/KiLlYoUrSeLf06/crhbys/blob/main/Screenshot/BR-R(3).png)  
```
systemctl restart network
ip -c a
```
![image](https://github.com/KiLlYoUrSeLf06/crhbys/blob/main/Screenshot/BR-R(4).png)  

## **BR-SRV**  
![image](https://github.com/KiLlYoUrSeLf06/crhbys/blob/main/Screenshot/BR-SRV(1).png)

```
ip -c a
```
![image](https://github.com/KiLlYoUrSeLf06/crhbys/blob/main/Screenshot/BR-SRV(2).png)
...
nmtui
``` 
![image](https://github.com/KiLlYoUrSeLf06/crhbys/blob/main/Screenshot/HQ-R(5).png)  
![image](https://github.com/KiLlYoUrSeLf06/crhbys/blob/main/Screenshot/HQ-R(6).png) 

## **BR-R**
```
nmtui
```
![image](https://github.com/KiLlYoUrSeLf06/crhbys/blob/main/Screenshot/BR-R(5).png)  
![image](https://github.com/KiLlYoUrSeLf06/crhbys/blob/main/Screenshot/BR-R(6).png)
...
ospfd=yes
```
![image](https://github.com/KiLlYoUrSeLf06/crhbys/blob/main/Screenshot/HQ-R(7).png)  
...
ospfd=yes
```
![image](https://github.com/KiLlYoUrSeLf06/crhbys/blob/main/Screenshot/BR-R(7).png)  
...
exit
```
![image](https://github.com/KiLlYoUrSeLf06/crhbys/blob/main/Screenshot/Screenshot_1.png)
...
enter
```
![image](https://github.com/KiLlYoUrSeLf06/crhbys/blob/main/Screenshot/HQ-R(9).png)  
```
cp /etc/dhcp/dhcpd.conf{.example,}
nano /etc/dhcp/dhcpd.conf
```
поправляем файл:  
![image](https://github.com/KiLlYoUrSeLf06/crhbys/blob/main/Screenshot/HQ-R(10).png)  
...
```
![image](https://github.com/KiLlYoUrSeLf06/crhbys/blob/main/Screenshot/HQ-R(11).png)   
...
![image](https://github.com/KiLlYoUrSeLf06/crhbys/blob/main/Screenshot/HQ-SRV(5).png)  
...
## **CLI**
![image](https://github.com/KiLlYoUrSeLf06/crhbys/blob/main/Screenshot/CLI(5).png)
...
```
![image](https://github.com/KiLlYoUrSeLf06/crhbys/blob/main/Screenshot/BR-R(9).png)  
...
passwd network-admin
```
![image](https://github.com/KiLlYoUrSeLf06/crhbys/blob/main/Screenshot/BR-SRV(5).png)  
...
passwd admin
```
![image](https://github.com/KiLlYoUrSeLf06/crhbys/blob/main/Screenshot/HQ-R(12).png)
...
passwd admin
```
![image](https://github.com/KiLlYoUrSeLf06/crhbys/blob/main/Screenshot/HQ-SRV(4).png)  
...
![image](https://github.com/KiLlYoUrSeLf06/crhbys/blob/main/Screenshot/HQ-R(13).png)
...
```
![image](https://github.com/KiLlYoUrSeLf06/crhbys/blob/main/Screenshot/HQ-R(14).png)  
```
ctrl-x
y
жмём enter
...
nano backup-script.sh
```
![image](https://github.com/KiLlYoUrSeLf06/crhbys/blob/main/Screenshot/BR-R(10).png)  
```
ctrl-x
y
жмём enter
...
![image](https://github.com/KiLlYoUrSeLf06/crhbys/blob/main/Screenshot/HQ-SRV(6).png)  
...
nft list ruleset
```
![image](https://github.com/KiLlYoUrSeLf06/crhbys/blob/main/Screenshot/HQ-R(15).png)  
...
```
![image](https://github.com/KiLlYoUrSeLf06/crhbys/blob/main/Screenshot/HQ-SRV(7).png)  
...
```
![image](https://github.com/KiLlYoUrSeLf06/crhbys/blob/main/Screenshot/HQ-SRV(8).png)  

```
systemctl restart nftables
nft list ruleset
```
![image](https://github.com/KiLlYoUrSeLf06/crhbys/blob/main/Screenshot/HQ-SRV(9).png)  

Выполняем проверку:  
## **CLI**
![image](https://github.com/KiLlYoUrSeLf06/crhbys/blob/main/Screenshot/CLI(6).png)  
